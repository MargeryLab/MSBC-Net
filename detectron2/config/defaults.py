...
_C.DATASETS.PRECOMPUTED_PROPOSAL_TOPK_TRAIN = 100
...
_C.MODEL.ROI_HEADS.NUM_CLASSES = 2
...
_C.MODEL.RETINANET.TOPK_CANDIDATES_TEST = 100
...
_C.TEST.AUG.MIN_SIZES = (256)
_C.TEST.AUG.MAX_SIZE = 512
